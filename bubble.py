...
class Bubble(Character):
    ...
    def __init__(self, images, sounds, dir, pos, speed, i):
    ...
    def remove(self, revival=False):
        ...
        if self.enemy and self.enemy.i == self.i:
    ...
    def collide_with_enemy(self):
        ...
        if enemy := pygame.sprite.spritecollideany(self, Enemy.group):
            if enemy.id != EnemyConfig.num_type and not enemy.is_dead and enemy.i == self.i:
                return enemy
        return None
